...
class LetterAdapter :
    ...
    override fun onBindViewHolder(holder: LetterViewHolder, position: Int) {
        ...
        holder.button.setOnClickListener {
            val action = LetterListFragmentDirections.actionLetterListFragmentToWordsListFragment(letter = holder.button.text.toString())
...
//            intent.putExtra(WordsListFragment.LETTER, holder.button.text.toString())
